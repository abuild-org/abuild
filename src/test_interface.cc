...
int main(int argc, char* argv[])
{
    ...
    Interface base("base", error, current_directory);
    ...
    Interface item1("item1", error, current_directory + "/item1");
    ...
    Interface item2("item2", error, current_directory + "/item2");
    ...
    Interface item3("item3", error, current_directory + "/item3");
    ...
    Interface item4("item4", error, current_directory + "/item4");
    ...
    Interface item5("item5", error, current_directory + "/item5");
    ...
    // and item5.
    Interface bad1("bad1", error, current_directory + "/bad1");
    ...
    Interface item6("item6", error, current_directory + "/item6");
    ...
    Interface item7("item7", error, current_directory + "/item7");
    ...
    Interface item8("item8", error, current_directory + "/item8");
